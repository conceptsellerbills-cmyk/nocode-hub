...
export function Comments({ title }: CommentsProps) {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-repo", "conceptsellerbills-cmyk/nocode-hub");
    script.setAttribute("data-repo-id", "R_kgDOR8_6OQ");
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOR8_6Oc4C6gbe");
