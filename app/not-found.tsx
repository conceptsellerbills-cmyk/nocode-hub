  ...
  return (
    <>
      <style>{`
        ...
        .nf-code{font-size:clamp(5rem,15vw,9rem);font-weight:900;line-height:1;background:linear-gradient(135deg,#6366f155,#6366f1);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-bottom:8px}
        ...
        .nf-btn-primary{background:#6366f1;color:#fff;border:none;padding:12px 28px;border-radius:8px;font-size:0.95rem;font-weight:700;cursor:pointer;text-decoration:none;transition:opacity 0.15s}
        ...
        .nf-btn-secondary:hover{border-color:#6366f1;color:#6366f1}
        ...
        .nf-card:hover{border-color:#6366f1;transform:translateY(-2px)}
