...
export const metadata: Metadata = { title: "Advertise — NoCode Hub", description: "Advertise with NoCode Hub and reach a targeted audience interested in no-code tools and platforms." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on NoCode Hub</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing no-code tools and platforms. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@nocode-hub.com">hello@nocode-hub.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
