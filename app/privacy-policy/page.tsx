...
export const metadata: Metadata = { title: "Privacy Policy — NoCode Hub", description: "Privacy Policy for NoCode Hub (nocode-hub.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>Welcome to NoCode Hub ("we", "us", or "our"), accessible at nocode-hub.com. This Privacy Policy explains how we collect, use, and protect your information when you visit our website.</p>
        ...
        <h2>6. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@nocode-hub.com">hello@nocode-hub.com</a>.</p>
        ...
        <h2>9. Contact</h2>
        <p>For privacy-related questions, contact us at <a href="mailto:hello@nocode-hub.com">hello@nocode-hub.com</a>.</p>
      </div>
    </>
  );
}
