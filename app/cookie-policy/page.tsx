...
export const metadata: Metadata = { title: "Cookie Policy — NoCode Hub", description: "Cookie Policy for NoCode Hub (nocode-hub.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@nocode-hub.com">hello@nocode-hub.com</a>.</p>
      </div>
    </>
  );
}
