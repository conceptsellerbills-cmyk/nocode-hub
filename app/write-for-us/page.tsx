...
export const metadata: Metadata = { title: "Write for Us — NoCode Hub", description: "Contribute a guest post to NoCode Hub. Share your expertise on no-code tools and platforms." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know no-code tools and platforms well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on no-code tools and platforms</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@nocode-hub.com">hello@nocode-hub.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
