...
export const metadata: Metadata = { title: "Contact — NoCode Hub", description: "Get in touch with the NoCode Hub team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@nocode-hub.com">hello@nocode-hub.com</a>. We reply within 1–2 business days.</p>
        </div>
